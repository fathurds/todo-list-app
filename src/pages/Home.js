...
function Home() {
  ...
  const handleSuccess = () => {
    ...
    Toast.fire({
      icon: 'success',
      title: `"${title}" berhasil ditambahkan.`
    })
  }
  ...
  return (
    <div className='container mx-auto'>
      ...
      <div className='flex justify-end gap-2 mx-2 my-3'>
        ...
        <button className='bg-red-500 text-slate-100 px-4 py-1 rounded-lg hover:bg-red-400 transition'>Logout</button>
      </div>
              ...
              <tr key={i}>
                ...
                <td className='border border-slate-300 px-2 py-2'>
                  <div className='flex flex-wrap gap-1 lg:flex-nowrap'>
                    <button className='btn-primary py-1 px-0 my-0 w-full'>Done</button>
                    <button className='btn-warning py-1 px-0 my-0'>Edit</button>
                    <button className='btn-danger py-1 px-0 my-0'>Delete</button>
                  </div>
                </td>
              </tr>
            ))}
      ...
      <div className="bg-black bg-opacity-50 absolute inset-0 hidden justify-center items-center" id="modalAdd">
        <div className="bg-gray-200 py-2 px-3 rounded-lg shadow-xl text-gray-800 w-[400px]">
          ...
          <div className="px-3">
            ...
            <button className='btn-primary w-full' disabled={isLoading ? true : false} onClick={addTodo}>Save</button>
          </div>
